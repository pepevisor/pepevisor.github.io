...
function backgroundFunc1() {

    document.body.style.backgroundImage="url(images/bocM0L_2.gif)";
}

function backgroundFunc2() {

    document.body.style.backgroundImage="url(images/bg_wtf.gif)";
}

function backgroundFunc3() {

    document.body.style.backgroundImage="url(images/bg_b_1.gif)";
}

function backgroundFunc4() {

    document.body.style.backgroundImage="url(images/bg_t.gif)";
}

function backgroundFunc5() {

    //document.body.style.backgroundImage="url(images/n54.gif)";
}
